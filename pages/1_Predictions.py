...
fcvc = st.slider(label = 'How often do you consume vegetables? (0 = Never / 3 = Always)', min_value = 1., max_value = 3.)
...
faf = st.slider(label = 'What is yout fisical activity frequency? (0 = Sedentary / 3 = High level activity)', min_value = 1., max_value = 3.)
tue = st.slider(label = 'How long do you use technological devices? (0 = Never / 2 = All the time)', min_value = 1., max_value = 2.)
